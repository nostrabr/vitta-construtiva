...
$filePathDesk = __DIR__ . '/../../../../assets/imagens/arquivos/banners/' . $nomeBannerDesktopDeletar;
if (file_exists($filePathDesk)) {
    unlink($filePathDesk);
}

// remover antigo banner mobile
$filePathMob = __DIR__ . '/../../../../assets/imagens/arquivos/banners/' . $nomeBannerMobileDeletar;
