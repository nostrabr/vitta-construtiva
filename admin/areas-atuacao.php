...
<body>
    ...
    <!-- MODAL ADDD ÁREA ATUAÇÃO -->
    <?php include_once "modulos-admin/contents/areas-atuacao/modais/add-area-atuacao.php"; ?>
    <!-- MODAL ADDD ÁREA ATUAÇÃO -->

    <!-- MODAL ADDD ÁREA ATUAÇÃO -->
    <?php include_once "modulos-admin/contents/areas-atuacao/modais/add-projetos.php"; ?>
    <!-- MODAL ADDD ÁREA ATUAÇÃO -->
